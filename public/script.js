...
buf.push("<a" + (jade.attr("id", uid+'-dot-'+num, true, false)) + (jade.attr("href", "#"+uid+'-'+num, true, false)) + (jade.attr("data-num", num, true, false)) + (jade.cls(['dot',looper(num,length,"dot-"+num+active)], [null,true])) + "></a>");
    }
