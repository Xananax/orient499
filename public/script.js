...
},{"../_templates/card.jade":11,"./apis/facebook.js":4,"./apis/instagram.js":5,"./apis/tumblr":6,"./jquery.event.move.js":7,"./jquery.event.swipe.js":8,"./sliders.js":10,"jquery-browserify":3}],10:[function(require,module,exports){
...
var buf = [];
var jade_mixins = {};
var locals_ = (locals || {}),l = locals_.l,prefix = locals_.prefix,suffix = locals_.suffix,card = locals_.card,i = locals_.i;
...
jade_mixins["card"] = function(card,uid){
...
buf.push("<div style=\"left:0px\" class=\"slides\">");
...
buf.push("<div" + (jade.attr("id", uid+'-'+num, true, false)) + (jade.cls(['slide',className], [null,true])) + ">");
if ((item.map))
{
jade_mixins["map"](item,card);
}
if ((item.filename))
{
jade_mixins["image"](item,card);
}
if ((item.text))
{
jade_mixins["text"](item,card);
}
buf.push("</div>");
    }
...
if ( length > 1)
{
jade_mixins["dots"](uid,card.content,length);
jade_mixins["slider-controls"]();
}
if ( card.clap)
{
jade_mixins["slider-title"](card);
}
if ( card.header)
{
jade_mixins["slider-header"](card);
}
buf.push("<a href=\"#\" class=\"close\"></a></div>");
};
jade_mixins["map"] = function(item,card){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div class=\"google-maps\"><iframe" + (jade.attr("src", item.map, true, false)) + " width=\"450\" height=\"450\" frameborder=\"0\" style=\"border:0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\"></iframe></div>");
};
jade_mixins["text"] = function(item,card){
var block = (this && this.block), attributes = (this && this.attributes) || {};
if(Object.prototype.toString.call(item.text) === '[object Array]'){
item.text = item.text.join('<br>');
}
buf.push("<div class=\"text-cell\"><div class=\"text-contents\"><p>" + (null == (jade.interp = processText(item.text)) ? "" : jade.interp) + "</p></div></div>");
};
jade_mixins["image"] = function(item,card){
var block = (this && this.block), attributes = (this && this.attributes) || {};
...
buf.push("<div class=\"image-loading\"><i class=\"image-loading-inner\"></i></div><div" + (jade.attr("style", 'background-image:url('+prefix+item.filename+suffix+')', true, false)) + (jade.cls(['image-inner',"image-focus-"+focus[0]+"-"+focus[1]], [null,true])) + "></div>");
if ( item.caption)
{
buf.push("<div class=\"image-caption\">" + (jade.escape(null == (jade.interp = item.caption) ? "" : jade.interp)) + "</div>");
}
};
jade_mixins["anchor"] = function(slug){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<a" + (jade.attr("name", slug, true, false)) + (jade.attr("id", slug, true, false)) + " class=\"anchor\"></a>");
};
jade_mixins["dots"] = function(uid,els,length){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div class=\"dots\">");
// iterate els
;(function(){
  var $$obj = els;
  if ('number' == typeof $$obj.length) {
...
buf.push("<a" + (jade.attr("href", "#"+uid+'-'+num, true, false)) + (jade.attr("data-num", num, true, false)) + (jade.cls(['dot',looper(num,length,"dot-"+num+active)], [null,true])) + "></a>");
    }
...
jade_mixins["slider"] = function(uid,images,size,title,slug){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div" + (jade.attr("id", 'card-'+uid, true, false)) + (jade.cls(['card','slider',size], [null,null,true])) + ">");
jade_mixins["anchor"](slug);
buf.push("<div style=\"left:0px;\" class=\"slides\">");
jade_mixins["images-gallery"](uid,images);
buf.push("</div>");
jade_mixins["dots"](uid,images);
jade_mixins["slider-controls"]();
if ( title)
{
jade_mixins["slider-title"](title);
}
buf.push("</div>");
};
jade_mixins["slider-title"] = function(item){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div class=\"slider-title\"><div class=\"slider-title-inner\"><h1>" + (jade.escape(null == (jade.interp = item.title) ? "" : jade.interp)) + "</h1></div></div>");
};
jade_mixins["slider-header"] = function(item){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div class=\"slider-header\"><h1>" + (jade.escape(null == (jade.interp = item.title) ? "" : jade.interp)) + "</h1></div>");
};
jade_mixins["slider-controls"] = function(){
var block = (this && this.block), attributes = (this && this.attributes) || {};
buf.push("<div class=\"slider-controls\"><a href=\"#\" data-dir=\"left\" class=\"slider-control slider-control-left\"><i></i></a><a href=\"#\" data-dir=\"right\" class=\"slider-control slider-control-right\"><i></i></a></div>");
};
